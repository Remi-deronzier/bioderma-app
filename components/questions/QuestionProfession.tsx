...
import AnswersProfession from "../answers/AnswersProfession";
const { height, width } = Dimensions.get("window");

const QuestionProfession = ({ question, answers, setUserStatus }) => {
  return (
    <QuizzContainer>
      <Box flex={1}>
        ...
        <AnswersProfession answers={answers} setUserStatus={setUserStatus} />
      </Box>
    </QuizzContainer>
  );
};
...
export default QuestionProfession;
